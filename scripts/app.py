...
# Valores baseados nas secções V e VI do teu documento [cite: 111-118]
if 'thresholds' not in st.session_state:
    st.session_state.thresholds = {
        "clim_fresco": 300,      # Banana/Maçã [cite: 112]
        "clim_maduro": 700,      # Banana/Maçã [cite: 113]
        "nclim_firme": 150,      # Laranja [cite: 116]
        "nclim_risco": 400       # Laranja [cite: 117]
    }
...
def processar_decisao(classe, voc):
    # Lógica assimétrica conforme definido no PDF 
    ...
    else: # Laranja (Não-climatérico) [cite: 115]
...
with tab_dash:
    if st.session_state.historico:
        ...
        # 1. CARD DE AÇÃO (Foco no trabalhador)
        st.markdown(f"""
        ...
        # 3. GRÁFICOS (Sintaxe 2026: width="stretch")
